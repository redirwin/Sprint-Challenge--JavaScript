...
const uni = universities.filter(universities => universities.includes("Uni")); // reuse universities array from request 1
console.log(uni);
...
const populationTotal = zooAnimals.reduce((currentCount, currentAnimal) => {
  return currentCount + currentAnimal.population;
}, 0);
